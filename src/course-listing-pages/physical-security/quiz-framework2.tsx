...
// Import custom CSS styles for the quiz component
import "./quiz-framework2.css";

// Define the QuizFramework2 functional component using React.FC type
const QuizFramework2: React.FC = () => {
    ...
    // Array of quiz questions, each with the question text, options, and the correct answer
    const questions = [
        {
                ...
                <div className="quiz-box">
                    ...
                    {questions[currentQuestion].options.map((option) => (
                        <button
                            ...
                            key={option}
                            // CSS class for styling the option buttons
...
// Export the QuizFramework2 component for use in other parts of the application
