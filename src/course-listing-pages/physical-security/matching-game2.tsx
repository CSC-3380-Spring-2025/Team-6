...
import "./matching-game2.css"; // Import custom CSS styles

// Define the structure for a card object in the game
interface Card {
...
// Define the initial pairs of terms and definitions for the game
const initialPairs = [
 ...
 * Uses the Fisher-Yates (Knuth) shuffle algorithm implicitly via sort with random values.
...
const MatchingGame: React.FC = () => {
    ...
    useEffect(() => {
        // Create separate arrays for terms and definitions from initialPairs
    ...
    const handleCardClick = (id: number) => {
        ...
        if (newSelected.length === 2) {
            ...
            if (firstCard && secondCard) {
                // Check if the values of the two cards form a valid pair (term/definition or definition/term)
    ...
    return (
        <div className="matching2-game body2"> {/* Main container for the game */}
            ...
            <div className="grid-container">
                ...
                {cards.map((card) => (
                    <div
                        ...
                        // Apply CSS classes conditionally: base class, 'matched' if matched, 'incorrect' if recently mismatched
                        className={`matching2-game-card ${card.matched ? "matched" : ""} ${card.incorrect ? "incorrect" : ""}`}
