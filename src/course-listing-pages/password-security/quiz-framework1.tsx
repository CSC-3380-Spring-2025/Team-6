...
// Import custom CSS styles for this specific quiz component (Quiz 1)
import "./quiz-framework1.css";

// Define the QuizFramework1 functional component using React.FC type
const QuizFramework1: React.FC = () => {
    ...
    // Array of quiz questions related to Password Security
    const questions = [
        {
            question: "What is the minimum number of characters a password should have?",
            options: ["12", "10", "16", "8"],
            answer: "16", // Note: While recommendations vary, this quiz uses 16 as the correct answer.
        },
        {
            question: "Which password is the strongest?",
            options: ["ILoveDog$", "password333", ":Fz7!397$pm>", "123456"],
            answer: ":Fz7!397$pm>", // Strong passwords are long, complex, and unpredictable.
        },
        {
            ...
            answer: "All of the above", // A mix of character types increases complexity.
        },
        {
            question: "You should use the same password for all your accounts.",
            options: ["True", "False"],
            answer: "False", // Reusing passwords is a significant security risk.
        },
    ];
    ...
    return (
        // Main container for the quiz layout (uses specific class 'quiz1-container')
        <div className="quiz1-container">
            ...
            {showResult ? (
                ...
                <div className="quiz-box result-container"> {/* Uses generic 'quiz-box' and 'result-container' */}
                    {/* Title indicating quiz completion */}
                    <h2 className="question-title">Quiz Completed!</h2> {/* Uses generic 'question-title' */}
                ...
                // Container for displaying the current question and options (uses specific class 'quiz1-box')
                <div className="quiz1-box">
                    {/* Display the text of the current question (uses specific class 'question1-title') */}
                    <h2 className="question1-title">{questions[currentQuestion].question}</h2>
                    ...
                    {questions[currentQuestion].options.map((option) => (
                        <button
                            ...
                            key={option}
                            // CSS class for styling the option buttons (uses specific class 'option1-button')
                            className="option1-button"
...
// Export the QuizFramework1 component for use in other parts of the application
